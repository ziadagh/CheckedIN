...
package com.example.ibrahim.myapplication.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SendMessage extends MessagingRequest<com.example.ibrahim.myapplication.backend.messaging.model.RegistrationRecordCollection> {

    private static final String REST_PATH = "send_message";
    ...
    protected SendMessage(java.lang.String message) {
      super(Messaging.this, "POST", REST_PATH, null, com.example.ibrahim.myapplication.backend.messaging.model.RegistrationRecordCollection.class);
  ...
  /**
   * Create a request for the method "sendMessageTo".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link SendMessageTo#execute()} method to invoke the remote operation.
   *
   * @param message
   * @param regId
   * @return the request
   */
  public SendMessageTo sendMessageTo(java.lang.String message, java.lang.String regId) throws java.io.IOException {
    SendMessageTo result = new SendMessageTo(message, regId);
    initialize(result);
    return result;
  }

  public class SendMessageTo extends MessagingRequest<Void> {

    private static final String REST_PATH = "send_message_to";

    /**
     * Create a request for the method "sendMessageTo".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link SendMessageTo#execute()} method to invoke the remote
     * operation. <p> {@link SendMessageTo#initialize(com.google.api.client.googleapis.services.Abstra
     ...
     * @since 1.13
     */
    protected SendMessageTo(java.lang.String message, java.lang.String regId) {
    ...
    @Override
    public SendMessageTo setAlt(java.lang.String alt) {
      return (SendMessageTo) super.setAlt(alt);
    }

    @Override
    public SendMessageTo setFields(java.lang.String fields) {
      return (SendMessageTo) super.setFields(fields);
    }

    @Override
    public SendMessageTo setKey(java.lang.String key) {
      return (SendMessageTo) super.setKey(key);
    }

    @Override
    public SendMessageTo setOauthToken(java.lang.String oauthToken) {
      return (SendMessageTo) super.setOauthToken(oauthToken);
    }

    @Override
    public SendMessageTo setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendMessageTo) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendMessageTo setQuotaUser(java.lang.String quotaUser) {
      return (SendMessageTo) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendMessageTo setUserIp(java.lang.String userIp) {
      return (SendMessageTo) super.setUserIp(userIp);
    }
    ...
    public SendMessageTo setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }
    ...
    public SendMessageTo setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }

    @Override
    public SendMessageTo set(String parameterName, Object value) {
      return (SendMessageTo) super.set(parameterName, value);
    }
  }
