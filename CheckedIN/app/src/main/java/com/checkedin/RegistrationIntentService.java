...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            // Initially this c
            // all goes out to the network to retrieve the token, subsequent calls are local.
            ...
            System.out.println("THIS IS REG ID: " + token);
            // [END get_token]
    ...
    private void sendRegistrationToServer(String token) {
        ...
        try {
            ...
            regService.register2(token, getShared().getString("username", "")).execute();
            System.out.println(getShared().getString("username", ""));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
